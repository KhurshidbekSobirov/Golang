...
type Email struct {
	...
	Recipients           string   `protobuf:"bytes,4,opt,name=Recipients,proto3" json:"Recipients"`
...
var fileDescriptor_36e0c56adf454aba = []byte{
	...
	0xc9, 0x33, 0x45, 0x82, 0x51, 0x81, 0x51, 0x83, 0x33, 0x88, 0xc9, 0x33, 0x45, 0x48, 0x82, 0x8b,
	0x3d, 0xb8, 0x34, 0x29, 0x2b, 0x35, 0xb9, 0x44, 0x82, 0x09, 0x2c, 0x08, 0xe3, 0x0a, 0x09, 0x71,
	0xb1, 0x38, 0xe5, 0xa7, 0x54, 0x4a, 0x30, 0x83, 0x85, 0xc1, 0x6c, 0x21, 0x39, 0x2e, 0xae, 0xa0,
	0xd4, 0xe4, 0xcc, 0x82, 0xcc, 0xd4, 0xbc, 0x92, 0x62, 0x09, 0x16, 0xb0, 0x0c, 0x92, 0x88, 0x12,
	0x3b, 0xc8, 0x9a, 0x82, 0x92, 0x4a, 0x27, 0x81, 0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63,
	0x7c, 0xf0, 0x48, 0x8e, 0x71, 0xc6, 0x63, 0x39, 0x86, 0x24, 0x36, 0xb0, 0x7b, 0x8c, 0x01, 0x01,
	0x00, 0x00, 0xff, 0xff, 0x83, 0x7f, 0x67, 0x84, 0xac, 0x00, 0x00, 0x00,
}
...
func (m *Email) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Recipients) > 0 {
		...
		i = encodeVarintEmail(dAtA, i, uint64(len(m.Recipients)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Body) > 0 {
